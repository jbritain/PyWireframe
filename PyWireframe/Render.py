...
def start():
    ...
    print("Pyreframe: Starting PyreFrame")
    print("Pyreframe: Importing Modules") 

    try:
        import turtle
    except ImportError:
        print("Pyreframe: Error importing modules. Make sure you have the Turtle module installed.")
        sys.exit()

    print("Pyreframe: Defining render")
    ...
    render.speed(0)
    render.hideturtle()
    render.screen.title("PyreFrame V0.1a")
    print("Pyreframe: PyreFrame has started succesfully!")
